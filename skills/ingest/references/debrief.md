...
6. Ask **Save this update?** This confirms the engineer's record update, not customer acceptance. On confirmation, apply precisely that proposal with `fde debrief --apply`; the saved lines remain sourced facts or decisions unless the acceptance owner and evidence are present. A material correction requires a revised review and renewed confirmation. On rejection, leave the proposal pending and do not apply.
