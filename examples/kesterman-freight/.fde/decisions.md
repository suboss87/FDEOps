...
5. One full floor shift on dashboard only (Randy's acceptance) - target week of 2026-07-20
...
- Decision: (b)
- Rationale: (a) renders data ops ignores; (c) already failed in 2023 - Karen's rewrite died because it started by taking the sheet away
- Owner: Denise Kowalczyk

### [2026-06-18] Scope change #1 - carrier ETA feed
- Context: Denise, weekly sync: "while you're in the ingest code, can we pull the FastLane ETA feed in too?"
...
- Owner: Denise Kowalczyk. Timeline: unchanged by her call - flagged that slices 3-5 absorb the risk

### [2026-06-25] Scope change #2 - CSV export for finance
- Context: finance controller (via Denise, email) wants the reconciled table in their nightly export format
...
- Context: Denise, email, same day she went quiet on demo invites: Nashville depot manager wants a filtered board view per role
...
- Owner: pending - Denise Kowalczyk
