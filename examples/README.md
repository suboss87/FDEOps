...
| [rennick-health/](./rennick-health/) | Early engagement, week 1. Trust RED with a dated `[signal:red]` token - the passed-over internal architect. Healthcare data boundary held in `risks.md` and `trust-profile.md`: PHI tagged `<private>` and kept out of prompts, policy-before-code. |
